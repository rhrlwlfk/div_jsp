<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%
	String s_name  = (String)session.getAttribute("s_name");//session에서 얻어오는것은 object이다.
	out.print("세션에서 가져온 값" + s_name);//null이 찍힘 아무것도 없어서
	if(s_name == null) {
%>
